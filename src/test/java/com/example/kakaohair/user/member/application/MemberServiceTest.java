...
class MemberServiceTest {
    ...
    @Test
    void findBySocialId() {
        given(memberRepository.findBySocialId(anyString())).willReturn(Optional.of(MemberFixture.memberWithId()));
        final TokenResponse expectedToken = TokenResponse.of(MemberFixture.memberWithId().getMemberInfo().getSocialId());
    ...
    void createdBySocialId() {
        ...
        given(memberRepository.save(any(Member.class))).willReturn(MemberFixture.memberWithId());
